...
mkdir /app/opencex -p
cd /app/opencex || exit
git clone https://github.com/RyuuzakiEru/OpenCEX-backend.git ./backend
git clone https://github.com/RyuuzakiEru/OpenCEX-frontend.git ./frontend
git clone https://github.com/RyuuzakiEru/OpenCEX-static.git ./nuxt
